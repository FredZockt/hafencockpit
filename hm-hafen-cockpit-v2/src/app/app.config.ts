...
import { ShipTrafficRepository } from './features/ship-traffic/data-access/ship-traffic.repository';
import { MockShipTrafficRepository } from './features/ship-traffic/data-access/mock-ship-traffic.repository';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    /*
     * SCHIFFSVERKEHR - hier zeigt sich der Wert des Vertrags.
     *
     * AIS ist die einzige Quelle, die nicht direkt aus dem Browser abrufbar ist:
     * Jeder Anbieter verlangt einen API-Key (der nicht ins Bundle darf), und
     * aisstream.io schließt Browser-Verbindungen ausdrücklich aus (kein CORS).
     *
     * Deshalb läuft das Widget derzeit gegen Demo-Daten. Sobald der Proxy steht,
     * ist der Umstieg auf echte Daten EXAKT DIESE EINE ZEILE:
     *
